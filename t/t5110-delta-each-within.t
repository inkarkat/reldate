...
run_with_input_produces_output(['--delta-each', '--within', 'all'], $input, qq{
...
At 1 year later than that, he said "Between 2 days before that and 5 days later than that".}, 'delta each in all');

run_with_input_produces_output(['--delta-each', '--within', '"[^"]+"'], $input, qq{
At 20180501_071159, we said "267 days ago will happen".
At 20181208_060000, she said "47 days ago was good, until 1 hour later than that".
At 20190108_060000, she said "Nee".
At 20190118_121111, he said "Between 4 days ago and 5 seconds later than that".
At 20190120_124000, she met 20190120_124000.
At 20200601_120000, he said "Between in 1 year and 5 days later than that".}, 'delta each inside double quoted text');
