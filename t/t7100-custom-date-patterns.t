...
my @args = ('--date-pattern', '\[(?<year>\d\d\d\d)(?<month>\d\d)(?<day>\d\d)\]', '--precision', '3');

run_with_input_produces_output([@args], "At [20190122], it broke.", "At 8 hours and 30 minutes ago, it broke.", 'custom pattern');
run_with_input_produces_output([@args], "At 20190122, it broke.", "At 20190122, it broke.", 'does not parse Ymd any longer');
